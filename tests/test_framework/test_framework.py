...
class TestFramework:
    ...
    def __parse_arguments(self):
        ...
        parser.add_argument(
            ...
            default=os.getenv(
                ...
                default=os.path.join(
                    __file_path__,
                    "../../ionian-rust/target/release/ionian_node"
                    + (".exe" if is_windows_platform() else ""),
                ),
            ),
            type=str,
        ...
        parser.add_argument(
            ...
            default=os.path.join(
                __file_path__,
                "../../ionian-rust/target/ionian-client"
                + (".exe" if is_windows_platform() else ""),
            ),
            type=str,
        )
        ...
        parser.add_argument(
            ...
            default=os.path.join(
                __file_path__,
                "../../ionian-rust/ionian-contracts/artifacts/contracts/dataFlow/Flow.sol/Flow.json",
            ),
            type=str,
        )
        ...
        parser.add_argument(
            ...
            default=os.path.join(
                __file_path__,
                "../../ionian-rust/ionian-contracts/artifacts/contracts/test/IonianMineTest.sol/IonianMineTest.json",
            ),
            type=str,
        )
    ...
    def main(self):
        ...
        self.kv_binary = self.options.ionian_kv
